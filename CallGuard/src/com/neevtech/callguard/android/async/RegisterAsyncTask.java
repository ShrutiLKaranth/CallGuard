...
public class RegisterAsyncTask extends BaseAsyncTask {
	...
	private final String LOG_TAG = RegisterAsyncTask.class.getSimpleName();

	public RegisterAsyncTask(Context context, AsyncTaskCallback taskCallback) {
	...
	protected ResponseDTO doInBackground(HashMap<String, String>... params) {
		try {
			...
			String followerListURL = HTTPJsonPost.getExactURL(
					...
					WebServiceConstants.REGISTER_URL);
